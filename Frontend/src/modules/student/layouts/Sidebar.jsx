function Sidebar({ activeItem, setActiveItem, setShowSidebar }) {
     return (
          <div className="flex h-screen max-sm:h-[91.5dvh]">
               <div className="w-64 bg-gray-800 text-white shadow-lg">
                    ...
                    <ul className="mt-4">
                         <li className={`px-5 py-3 hover:bg-gray-700 transition-colors flex ${activeItem === 'dashboard' ? 'bg-gray-700' : ''}`}
                              onClick={() => {
                         ...
                         <li className={`px-5 py-3 hover:bg-gray-700 transition-colors flex ${activeItem === 'announcements' ? 'bg-gray-700' : ''}`}
                              onClick={() => {
                         ...
                         <li className={`px-5 py-3 hover:bg-gray-700 transition-colors flex ${activeItem === 'classGroup' ? 'bg-gray-700' : ''}`}
                         onClick={() => {
                              setActiveItem('classGroup');
                              setShowSidebar(false);
                         }}>
                         ...
                         <li className={`px-5 py-3 hover:bg-gray-700 transition-colors flex ${activeItem === 'feePayment' ? 'bg-gray-700' : ''}`}>
                              <a href="https://campuspayfrontend.onrender.com/login/student" target="_blank" rel="noopener noreferrer" className="flex items-center">
                              <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                              <span>Fee Payment</span>
                              </a>
                         </li>

                         <li className={`px-5 py-3 hover:bg-gray-700 transition-colors flex ${activeItem === 'assignments' ? 'bg-gray-700' : ''}`}
                              onClick={() => {
                         ...
                         <li className={`px-5 py-3 hover:bg-gray-700 transition-colors flex ${activeItem === 'studyMaterial' ? 'bg-gray-700' : ''}`}
                              onClick={() => {
                                   setActiveItem('studyMaterial');
                                   setShowSidebar(false);
                              }}>
                         ...
                         <li className={`px-5 py-3 hover:bg-gray-700 transition-colors flex ${activeItem === 'ai Tutor' ? 'bg-gray-700' : ''}`}
                         onClick={() => {
                              setActiveItem('ai Tutor');
                              setShowSidebar(false);
                         }}>
                         ...
                         <li className={`px-5 py-3 hover:bg-gray-700 transition-colors flex ${activeItem === 'logout' ? 'bg-gray-700' : ''}`}
